    ...
    <>
      ...
      >
        <div className="container-page flex h-16 md:h-20 items-center justify-between">
          ...
          >
            <span className="text-cocoa-800 dark:text-cream-50 transition-colors">SAVA</span>
          ...
          <nav className="hidden lg:flex items-center gap-1">
            {nav.map((item) => (
              <Link
                key={item.href}
                href={item.href}
                className="relative px-4 py-2 text-sm font-medium text-cocoa-800/80 hover:text-cocoa-900 dark:text-cream-100/80 dark:hover:text-cream-50 transition-colors duration-400 ease-apple group"
              >
                {item.label}
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="hidden md:inline-flex h-10 w-10 items-center justify-center rounded-full text-cocoa-700 dark:text-cream-100 hover:bg-cocoa-700/5 dark:hover:bg-cream-100/5 transition-colors"
            >
            ...
            <button
              ...
              className="lg:hidden h-10 w-10 inline-flex items-center justify-center rounded-full text-cocoa-700 dark:text-cream-100 hover:bg-cocoa-700/5 dark:hover:bg-cream-100/5"
            >
              <Menu size={20} />
            </button>
          </div>
